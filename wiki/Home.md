# maczo Originals — Cases · Provably Fair

Welcome. This wiki explains how every **Cases** result on [maczo.co](https://maczo.co) is provably
...
- 🔐 **[The Algorithm](Algorithm)** — the HMAC-SHA256 → uint32 engine + Cases's resolve step
...
- **Live (offline in your browser):** https://verify.maczo.co/originals/?game=cases
- **Source / Node CLI:** https://github.com/maczo-co/originals-cases
- **Published odds:** https://verify.maczo.co/originals/paytables/cases.json
